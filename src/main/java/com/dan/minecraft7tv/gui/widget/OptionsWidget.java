...
public class OptionsWidget extends SettingWidget {
    ...
    public OptionsWidget(float x, float y, float width, String description, List<String> options, String start, int def, Action<String> onSelect) {
        ...
        this.text = new TextFieldWidget(super.getX() + 5 + 3 , (float) (getY() + (getHeight() - getY()) / 2 - 0.25) - 5, super.getX() + 13 + MinecraftClient.getInstance().textRenderer.getWidth(this.options.get(indexOfLongest)) * 0.6f,
